...
**v0.3.0-beta.1** - Released 2026-04-03
...
|---------|--------|----------|
| Lite | ✅ Released | 100% |
| Standard | 🟡 In Development | 60% |
| Pro | ⚪ Planning | 20% |

### Implemented Features (v0.3.0)

#### Core Features
- ✅ Three-tier product architecture (Lite/Standard/Pro)
- ✅ Native desktop implementations (egui/GTK4/SwiftUI)
...
#### Standard Edition (Partial)
- ✅ SFTP file transfer
- ✅ Server monitoring dashboard
- ✅ Docker container management
- 🟡 Embedded terminal (in progress)
- 🟡 Split-screen layout (in progress)
...
**Linux (Ubuntu/Debian):**
```bash
sudo apt-get install -y libgtk-4-dev libadwaita-1-dev libssh2-1-dev
```

**Windows:**
- No additional dependencies required for Lite
...
#### 核心功能
- ✅ 三层产品架构 (Lite/Standard/Pro)
- ✅ 原生桌面实现 (egui/GTK4/SwiftUI)
