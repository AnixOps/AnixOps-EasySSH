...
fn bench_password_encryption(c: &mut Criterion) {
    ...
    let passwords: [(&str, &str); 3] = [
        ("short", "123456"),
        ("medium", "secure_password_123"),
        ("long", ""),
    ];
